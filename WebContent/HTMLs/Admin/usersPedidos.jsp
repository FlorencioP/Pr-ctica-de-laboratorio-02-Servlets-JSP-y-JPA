	...
	<table class='tg' style='width:95%'>
	    ...
	    <% 
	    	...
	    	for (int i=0;i<list.size();i++){
	    		...
	    		out.println("<td class=\"tg-y698\"><BUTTON onclick=\"CambiarEstad("+prod.getUsuario().getId()+", 'A' ,"+id+")\">Aprobar pedido</BUTTON></td>");
	    		
	    		
	    		//out.println("<td class='tg-y698'><BUTTON onclick='CambiarEstad("+prod.getFk_usu_id()+", "+EstaR+" ,"+id+")'>Rechazar pedido</BUTTON></td>");
	    		out.println("<td class=\"tg-y698\"><BUTTON onclick=\"CambiarEstad("+prod.getUsuario().getId()+", 'R' ,"+id+")\">Rechazar pedido</BUTTON></td>");
