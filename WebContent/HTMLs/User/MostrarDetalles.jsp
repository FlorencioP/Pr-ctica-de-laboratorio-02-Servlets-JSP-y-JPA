	...
	<table class='tg' style='width:95%'>
	    ...
	    <% for (int i=0;i<list.size();i++){
	    		...
	    		out.println("<tr><td class='tg-y698'>"+prod.getNombre()+"</td><td class='tg-y698'>"+prod.getDescripcion()+"</td><td" +
	    					...
	    					" value='Modificar' onclick='modificarPed(this,"+pedDet.getPedidoCabecera().getId()+","+pedDet.getId()+","+prod.getId()+")'></td>"+
	    					"<td class='tg-y698'><input type='button' value='Eliminar' onclick='eliminarDET("+pedDet.getId()+","+pedDet.getPedidoCabecera().getId()+")'></td>");
	       }
	    %>
